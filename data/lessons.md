...
- `2026-06-18` — STRONG risk-on, broad green (VOO +1.63%, QQQ +2.74%, DIA +1.86%); leadership: **semiconductors/AI ripped HARD** (MU +11.1%, AMD +9.2%, SMH +6.5%, AVGO +6.2%, TSM +5.4%; NVDA +1.1%) while **mega-cap software sold off** (CRM -8.5%, NFLX -5.2%, ORCL -1.6%) — a clean rotation INTO chips, OUT of software; volatility: elevated single-name dispersion; backdrop: Iran shipping-deal optimism vs a hawkish Fed. _vs prior 06-17 pm (semis cooling/faded): leadership flipped back to chips with conviction — yesterday's pullback did not stick. Recurring trap to remember: chasing one-day +9-11% semis pops; flagged MU/TSM/AMD as watch (NOT buy) at extended prices._
