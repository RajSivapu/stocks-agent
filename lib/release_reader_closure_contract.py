"""Frozen database read contract for the one-time 20261017 reader closure."""
from __future__ import annotations

CLOSURE_READER_CONTRACT = "closure-20261017"

# Keep this tuple immutable when later releases add tables. An unresolved
# closure lease must be recoverable against the schema authorized at 20261017.
CLOSURE_READ_TABLES = (
    "holdings",
    "transactions",
    "portfolio_commands",
