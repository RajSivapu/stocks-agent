...
RECOVERY_SQL = {
    ...
    "theme_episode_revisions_v2": """SELECT revision_id::text AS revision_id,theme_id,episode_id::text AS episode_id,
        ...
        invalidation_conditions,first_seen::text AS first_seen,last_seen::text AS last_seen,
        next_review_at::text AS next_review_at,expires_at::text AS expires_at,state,closure_reason,reopen_reason,
    ...
    "source_receipts": """SELECT id::text AS id,run_id::text AS run_id,reservation_id::text AS reservation_id,
        provider,status,cache_key,requested_window,retrieved_at::text AS retrieved_at,expires_at::text AS expires_at,
...
READ_TABLES = (
    ...
    "market_source_items", "market_intelligence_run_items", "market_source_item_provenance",
    ...
    "market_reference_manifests", "market_security_reference_revisions", "market_discovery_stage_tasks",
    ...
    "market_theme_episode_revisions_v2", "market_reviewer_identity_receipts_v2",
    "market_research_nomination_requests_v2", "market_research_nominations_v2",
    "market_research_nomination_lifecycle_v2", "market_intelligence_memory_context_bindings_v2",
