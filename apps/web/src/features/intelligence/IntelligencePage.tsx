  ...
  return (
    <div className="page-stack intelligence-view">
      ...
      <details className="section-block disclosure-block"><summary><h2>Evidence and diagnostics</h2></summary><div className="disclosure-content">
        <section><h3>Evidence passages</h3>{data.evidence.length ? data.evidence.map((item) => <EvidencePassage evidence={item} key={item.evidence_id} />) : <p className="empty-copy">No shareable evidence passage is available.</p>}</section>
